PRINT 'Задание 1: Список индексов в базе UNIVER';
SELECT 
    t.name AS TableName, 
    i.name AS IndexName, 
...
WHILE @i < 1000
BEGIN
    INSERT INTO #EXPLRE (TIND, TF) VALUES (@i, REPLICATE('строка ', 10));
    SET @i = @i + 1;
END;
GO
...
WHILE @j < 20000
BEGIN
    INSERT INTO #EX (TKEY, TF) VALUES (FLOOR(30000*RAND()), REPLICATE('строка ', 10));
    SET @j = @j + 1;
END;
GO
